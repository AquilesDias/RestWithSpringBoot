...
import br.com.development.spring.restwithspringboot.converter.custom.PersonConverter;
...
public class PersonServices {
    ...
    public PersonDtoV2 createV2(PersonDtoV2 person){
        var entity = personConverter.converterDtoV2ToEntity(person);
        var vo = personConverter.converterEntityToDtoV2(personRepository.save(entity));
        return vo;
    }
